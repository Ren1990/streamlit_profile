...
with body:
   ...
   with col2:
      with stylable_container(
         ...
         pdf_viewer("assets\Bank Term Deposition Marketing Campaigns Outcome Prediction Modeling.pdf",width=700,height=400)
   ...
   with col2:
      with stylable_container(
         ...
         pdf_viewer("assets\House Price Prediction Modeling.pdf",width=700,height=400)
